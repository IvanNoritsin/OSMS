...
plt.xlim(0)
plt.ylim(-0.5, 1.5)
plt.title('Битовая последовательность, кодирующая имя и фамилию')
...
plt.figure(figsize=(13, 10))
plt.step(range(len(bit_sequence_crc_gold)), bit_sequence_crc_gold, where='post', color='b', linewidth=2)
plt.yticks([0, 1], ['0', '1'])
plt.xlim(0)
plt.ylim(-0.5, 1.5)
...
plt.figure(figsize=(13, 10))
plt.step(range(len(bit_sequence_crc_gold_restored)), bit_sequence_crc_gold_restored, where='post', color='b', linewidth=2)
plt.yticks([0, 1], ['0', '1'])
plt.xlim(0)
plt.ylim(-1, 2)
...
plt.figure(figsize=(13, 10))
plt.step(range(len(bit_sequence_crc_restored)), bit_sequence_crc_restored, where='post', color='b', linewidth=2)
plt.yticks([0, 1], ['0', '1'])
plt.xlim(0)
plt.ylim(-1, 2)
